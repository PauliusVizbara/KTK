  ...
  return (
    <div className="flex flex-col items-center w-full p-4 bg-white shadow rounded-lg border border-zinc-200">
      ...
      <div className="flex justify-around w-full">
        <PlayerResource name={player1.teamSelection.name} cp={player1.cp} setCp={player1.setCp} />
        <div className="w-px bg-zinc-200 mx-4" />
        <PlayerResource name={player2.teamSelection.name} cp={player2.cp} setCp={player2.setCp} />
      </div>
    </div>
  )
}
